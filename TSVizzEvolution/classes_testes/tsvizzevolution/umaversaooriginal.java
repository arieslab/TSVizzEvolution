...
public class umaversaooriginal extends javax.swing.JFrame {
    ...
    public umaversaooriginal() throws IOException {
    ...
    private void btnChooseFileSearchActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        int returnVal = fc.showOpenDialog(umaversaooriginal.this);
