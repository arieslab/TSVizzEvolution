...
public class umaversao extends JFrame {
...
//    public JPanel pnlGenerateGraph;
    ...
    public umaversao() throws IOException {
...
//        pnlGenerateGraph.setVisible(false);
    ...
    private void btnChooseFileSearch1ActionPerformed(ActionEvent evt) {
        ...
        int returnVal = fc.showOpenDialog(umaversao.this);
    ...
    private void btnGerarGrafoActionPerformed(ActionEvent evt) {
        try {
            ...
            Logger.getLogger(umaversao.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) throws IOException {
        try {
            ...
            java.util.logging.Logger.getLogger(umaversao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
							         			...
							         			gl_pnlGraph.createParallelGroup(Alignment.TRAILING)
							         				.addGroup(gl_pnlGraph.createSequentialGroup()
							         					...
							         					.addGroup(gl_pnlGraph.createParallelGroup(Alignment.TRAILING)
							         						...
							         						.addGroup(gl_pnlGraph.createSequentialGroup()
							         							.addComponent(pnlMethod, GroupLayout.DEFAULT_SIZE, 679, Short.MAX_VALUE)
							         							.addContainerGap())
							         						.addGroup(gl_pnlGraph.createSequentialGroup()
							         							.addComponent(pnlTestSmells, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
							         							.addContainerGap(273, Short.MAX_VALUE))
							         						.addGroup(gl_pnlGraph.createSequentialGroup()
							         							.addComponent(pnlClass, GroupLayout.DEFAULT_SIZE, 486, Short.MAX_VALUE)
							         							.addGap(203))
							         						.addGroup(gl_pnlGraph.createSequentialGroup()
							         						...
							         						.addGroup(Alignment.LEADING, gl_pnlGraph.createSequentialGroup()
							         							...
							         							.addGroup(gl_pnlGraph.createParallelGroup(Alignment.LEADING)
							         								.addComponent(btnUpload, GroupLayout.PREFERRED_SIZE, 233, GroupLayout.PREFERRED_SIZE)
							         			...
							         			gl_pnlMethod.createParallelGroup(Alignment.LEADING)
							         				.addGroup(gl_pnlMethod.createSequentialGroup()
							         					...
							         					.addGroup(gl_pnlMethod.createParallelGroup(Alignment.BASELINE)
							         						.addComponent(txtFilePathMethod, GroupLayout.PREFERRED_SIZE, 34, GroupLayout.PREFERRED_SIZE)
