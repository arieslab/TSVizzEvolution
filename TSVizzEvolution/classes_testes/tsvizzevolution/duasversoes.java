...
public class duasversoes extends JFrame {
    ...
    public duasversoes() throws IOException {
    ...
    private void btnChooseFileSearch1ActionPerformed(ActionEvent evt) {
        ...
        int returnVal = fc.showOpenDialog(duasversoes.this);
    ...
    private void iniciaProcessamento() {
		...
		new Thread() {
            ...
            Logger.getLogger(duasversoes.class.getName()).log(Level.SEVERE, null, ex);
		}
	}
}.start();
}
    ...
    public static void main(String args[]) throws IOException {
        try {
            ...
            java.util.logging.Logger.getLogger(duasversoes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
					new duasversoes().setVisible(true);
				} catch (IOException e) {
